          ...
          {events.map((event) => (
            <li key={event.id} className="event-item">
              ...
              <div className="assigned-quizzes">
                ...
                {event.quiz ? (
                  <ul>
                    <li key={event.quiz.id} className="quiz-item">
                      {event.quiz.title}{" "}
                      <span className={event.quiz.open ? "open" : "closed"}>
                          {event.quiz.open ? "Open" : "Closed"}
                        </span>
                    </li>
                  </ul>
                ) : (
                  <p className="no-quizzes">No quiz assigned yet.</p>
                )}
              </div>
